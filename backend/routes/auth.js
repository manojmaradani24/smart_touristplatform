...
const predefinedUsers = [
  ...
  { email: 'surya@gmail.com', password: 'surya123', name: 'Surya Patel', userType: 'predefined' },
  { email: 'josh@gmail.com', password: 'josh123', name: 'Josh Mathew', userType: 'predefined' },
  ...
  try {
    for (const userData of predefinedUsers) {
      ...
      if (!existingUser) {
        ...
        await user.save();
        console.log(`Predefined user created: ${userData.email}`);
      }
    }
  } catch (error) {
...
router.post('/register', [
  ...
  body('businessType').optional().isIn(['msme', 'developer', 'worker', 'student'])
], async (req, res) => {
  try {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
